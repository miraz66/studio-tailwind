    ...
    <div>
      <div className="pt-40">
        <div className="grid md:grid-cols-2 text-gray-100 md:border-y border-neutral-800">
          <div
            ...
            className="md:py-6 lg:py-10 2xl:py-16 hover:bg-neutral-900 ease-in-out duration-200 max-lg:border-y md:border-r border-neutral-800 flex items-center cursor-pointer"
          >
            <div
          ...
          <div
            ...
            className="xl:py-16 hover:bg-neutral-900 max-lg:border-b border-neutral-800  ease-in-out duration-200 flex items-center cursor-pointer"
          >
            <div
              style={{ wordSpacing: "-5px" }}
      ...
      <div className="grid md:grid-cols-4 gap-3 max-w-7xl mx-auto px-5 py-10">
        <div className="text-gray-100">
          ...
          <h3 className="pt-6 pb-1 text-xl tracking-tight">Copenhagen</h3>
        ...
        <div className="text-gray-100">
          <h3 className="pt-14 text-xl pb-1">Billund</h3>
          <div className="text-sm text-gray-300 leading-6">
            <p>24 Lego Allé</p>
        ...
        <div className="col-span-2 text-gray-100">
          <h2 className="text-xl font-semibold pb-7">Follow us</h2>
          <div className="flex gap-8">
            <a
              href=""
              className="hover:text-neutral-400 ease-in-out duration-200"
            >
              <svg
                viewBox="0 0 24 24"
                aria-hidden="true"
