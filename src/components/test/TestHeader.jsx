                    ...
                    <g className="origin-center scale-100 transition duration-500 motion-safe:group-hover:scale-105">
                      <foreignObject width="719" height="680">
                        <img
                          ...
                          src="https://images.unsplash.com/photo-1694587971464-0c03c44e2899?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1070&q=80"
                          style={{
                            color: "transparent",
                            aspectRatio: "719 / 680",
                          }}
              ...
              <div className="mt-6">
                <div className="space-y-6 text-base text-neutral-600">
                  <p>
                    ...
                    out by 6 weeks due to a change in{" "}
                    ...
                    <li className="group mt-10 first:mt-0">
                      <div style={{ opacity: 1, transform: "none" }}>
                        <div className="pt-10 group-first:pt-0 group-first:before:hidden group-first:after:hidden relative before:absolute after:absolute before:bg-neutral-950 after:bg-neutral-950/10 before:left-0 before:top-0 before:h-px before:w-6 after:left-8 after:right-0 after:top-0 after:h-px">
                          ...
                          would be impressive if our tests weren’t as porous as
                          a sieve.
                        </div>
                      </div>
                    </li>
                    ...
                    <li className="group mt-10 first:mt-0">
                      <div style={{ opacity: 1, transform: "none" }}>
                        <div className="pt-10 group-first:pt-0 group-first:before:hidden group-first:after:hidden relative before:absolute after:absolute before:bg-neutral-950 after:bg-neutral-950/10 before:left-0 before:top-0 before:h-px before:w-6 after:left-8 after:right-0 after:top-0 after:h-px">
                          ...
                          service your business uses, you can expect a lifetime
                  ...
                  <g className="origin-center scale-100 transition duration-500 motion-safe:group-hover:scale-105">
                    <foreignObject width="655" height="680">
                      <img
                        ...
                        src="/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fwhiteboard.2d6ee65a.jpg&amp;w=3840&amp;q=75"
                      />
                    </foreignObject>
                  </g>
                  <use
