    ...
    <>
      <div className="max-w-7xl mx-auto my-20 p-5">
        <div className="max-w-3xl">
          <h5 className="text-neutral-950 text-xl font-semibold tracking-tight">
            Services
          </h5>
          <h4 className="py-5 text-4xl text-neutral-950 font-semibold tracking-tighter leading-tight">
            We help you identify, explore and respond to new opportunities.
          </h4>
          <p className="text-lg text-neutral-600 font-medium tracking-tight">
