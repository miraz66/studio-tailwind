        ...
        <div className="max-w-3xl mx-auto">
          <div className="[&amp;>*]:mx-auto [&amp;>*]:max-w-3xl [&amp;>:first-child]:!mt-0 [&amp;>:last-child]:!mb-0 mt-24 sm:mt-32 lg:mt-40">
            ...
            <p>
              ...
              realised that there is an intangible benefit to seeing everyone’s
              screen at all times, that isn’t easily measurable in numbers.
            </p>
            <p>
          ...
          <div className="my-10 pl-8 relative before:absolute after:absolute before:bg-neutral-950 after:bg-neutral-950/10 before:left-0 before:top-0 before:h-6 before:w-px after:bottom-0 after:left-0 after:top-8 after:w-px">
            ...
            <div className="mt-4">
              <p>
                ...
                monitor attendance while maintaining a fun atmosphere. Expect to
                hear things like “Back at the coalface today!”.
              </p>
            </div>
          </div>
          ...
          <p>
            We parted ways with almost all of our senior development team within
            the first month of going back to the office, due to some
            irreconcilable differences. Stressed and worried, we decided to try
          ...
          <p>
            ...
            grads brought to our organisation and have since vowed to never hire
