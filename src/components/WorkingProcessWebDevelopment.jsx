        ...
        <article className="mx-auto max-w-3xl mt-24 sm:mt-32 lg:mt-40">
          <div className="mx-auto max-w-2xl lg:max-w-none">
            ...
            <p className="text-lg font-medium text-neutral-800 tracking-tight">
              ...
              Overflow, to become one of the most popular sites on the internet
            ...
            <p className="text-lg font-medium text-neutral-800 tracking-tight">
              ...
              once for your whole application, now you will need to decide every
              time you write a new component.
            </p>
            <p className="text-lg font-medium text-neutral-800 tracking-tight">
            ...
            <p className="text-lg font-medium text-neutral-800 tracking-tight">
              ...
              before. For example, we’ve reduced the Time to First Byte (TTFB)
              of this blog to -0.4s. That means it actually loaded before you
              clicked the link.
            </p>
            <div className="isolate my-10 overflow-hidden rounded-4xl max-sm:-mx-6">
              <img
