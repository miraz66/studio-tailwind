            ...
            <div className="lg:flex lg:items-center lg:justify-end lg:gap-x-8 lg:group-even/section:justify-start xl:gap-x-20">
              ...
              <div className="mt-12 lg:mt-0 lg:w-[37rem] lg:flex-none lg:group-even/section:order-first">
                <div style={{ opacity: 1, transform: "none" }}>
                  ...
                  <h2 className="mt-2 font-display text-3xl font-medium tracking-tighter text-neutral-950 sm:text-4xl">
                    Discover
                  </h2>
                    ...
                    <div className="mt-6">
                      <div className="space-y-6 text-base text-neutral-600">
                        <p>
                          ...
                          comprehensive roadmap for each product and start
                          working towards delivery. The roadmap is an
                          intricately tangled mess of technical nonsense
                        ...
                        <p>
                          ...
                          the client’s incessant nagging and the development
                          team who are hard at work scouring open source
                          projects for code to re-purpose.
                        </p>
                        <p>
                          Our account managers are trained to only reply to
                          client emails after 9pm, several days after the
                          initial email. This reinforces the general aura that
                          we are very busy and dissuades clients from asking for
                          changes.
                        </p>
                      </div>
                          ...
                          <g className="origin-center scale-100 transition duration-500 motion-safe:group-hover:scale-105">
                            <foreignObject width="719" height="680">
                              <img
                                ...
                                sizes="(min-width: 1024px) 41rem, 31rem"
                                // srcSet="/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fmeeting.0efc6edc.jpg&amp;w=16&amp;q=75 16w, /_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fmeeting.0efc6edc.jpg&amp;w=32&amp;q=75 32w, /_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fmeeting.0efc6edc.jpg&amp;w=48&amp;q=75 48w, /_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fmeeting.0efc6edc.jpg&amp;w=64&amp;q=75 64w, /_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fmeeting.0efc6edc.jpg&amp;w=96&amp;q=75 96w, /_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fmeeting.0efc6edc.jpg&amp;w=128&amp;q=75 128w, /_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fmeeting.0efc6edc.jpg&amp;w=256&amp;q=75 256w, /_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fmeeting.0efc6edc.jpg&amp;w=384&amp;q=75 384w, /_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fmeeting.0efc6edc.jpg&amp;w=640&amp;q=75 640w, /_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fmeeting.0efc6edc.jpg&amp;w=750&amp;q=75 750w, /_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fmeeting.0efc6edc.jpg&amp;w=828&amp;q=75 828w, /_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fmeeting.0efc6edc.jpg&amp;w=1080&amp;q=75 1080w, /_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fmeeting.0efc6edc.jpg&amp;w=1200&amp;q=75 1200w, /_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fmeeting.0efc6edc.jpg&amp;w=1920&amp;q=75 1920w, /_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fmeeting.0efc6edc.jpg&amp;w=2048&amp;q=75 2048w, /_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fmeeting.0efc6edc.jpg&amp;w=3840&amp;q=75 3840w"
                                src="https://studio.tailwindui.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fmeeting.0efc6edc.jpg&w=828&q=75"
                              />
                            </foreignObject>
                          </g>
                          <use
                  ...
                  <div style={{ opacity: 1, transform: "none" }}>
                    ...
                    <div className="mt-6">
                      <div className="space-y-6 text-base text-neutral-600">
                        ...
                        <p>
                          Despite largely using pre-built components, most of
                          the{" "}
                          <strong className="font-semibold text-neutral-950">
                            progress
                          </strong>{" "}
                          ...
                          <li className="group mt-10 first:mt-0">
                            <div style={{ opacity: 1, transform: "none" }}>
                              <div className="pt-10 group-first:pt-0 group-first:before:hidden group-first:after:hidden relative before:absolute after:absolute before:bg-neutral-950 after:bg-neutral-950/10 before:left-0 before:top-0 before:h-px before:w-6 after:left-8 after:right-0 after:top-0 after:h-px">
                                ...
                                which would be impressive if our tests weren’t
                          ...
                          <li className="group mt-10 first:mt-0">
                            <div style={{ opacity: 1, transform: "none" }}>
                              <div className="pt-10 group-first:pt-0 group-first:before:hidden group-first:after:hidden relative before:absolute after:absolute before:bg-neutral-950 after:bg-neutral-950/10 before:left-0 before:top-0 before:h-px before:w-6 after:left-8 after:right-0 after:top-0 after:h-px">
                                ...
                                To ensure reliability we only use the best
                                Digital Ocean droplets that $4 a month can buy.
                              </div>
                            </div>
                          </li>
                          <li className="group mt-10 first:mt-0">
                            <div style={{ opacity: 1, transform: "none" }}>
                              <div className="pt-10 group-first:pt-0 group-first:before:hidden group-first:after:hidden relative before:absolute after:absolute before:bg-neutral-950 after:bg-neutral-950/10 before:left-0 before:top-0 before:h-px before:w-6 after:left-8 after:right-0 after:top-0 after:h-px">
                                ...
                                Because we hold the API keys for every critical
                                service your business uses, you can expect a
                                lifetime of support, and invoices, from us.
                              </div>
                            </div>
                          </li>
                        </ul>
