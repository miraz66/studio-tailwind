  ...
  return (
    <div>
      ...
      <div className="bg-black text-white pt-2">
        <div className="max-w-7xl h-[50rem] mx-auto pt-44"></div>
      </div>

      <div
        className={
          isOpen
            ? "bg-white -mt-[50rem] w-full rounded-t-[40px] ease-in-out duration-700"
            : "bg-white -mt-10 w-full rounded-t-[40px] ease-in-out duration-700"
        }
      >
        <HomeDisplay>
          <div className="absolute top-52 w-full">
            <div className="max-w-7xl mx-auto px-6">dfdsf</div>
          </div>
        </HomeDisplay>
      </div>
    </div>
